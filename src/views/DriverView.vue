                ...
                <div class="bg-white px-4 py-5 sm:p-6">
                    <div>
                        <input type="text" name="name" id="name" v-model="driverDetails.name" placeholder="Full Name"
                            class="mt-1 block w-full px-3 py-2 rounded-md border border-gray-300 shadow-sm bg-white text-black"/>
                    </div>
                    <div>
                    ...
                    <div>
                        <input type="text" name="license_plate" v-model="driverDetails.license_plate" id="license_plate" placeholder="License Plate"
                            class="mt-1 block w-full px-3 py-2 rounded-md border border-gray-300 shadow-sm bg-white text-black"/>
                    </div>
                </div>
